...
(function (api) {
    ...
    function Plyr(container) {
        ...
        function _parseSource(sources) {
            ...
            // .source('http://www.zi-han.net/theme/hplus/js/plugins/plyr/path/to/video.mp4')
            ...
            // .source([{ src: 'http://www.zi-han.net/theme/hplus/js/plugins/plyr/path/to/video.mp4', type: 'video/mp4' },{ src: 'http://www.zi-han.net/theme/hplus/js/plugins/plyr/path/to/video.webm', type: 'video/webm' }])
