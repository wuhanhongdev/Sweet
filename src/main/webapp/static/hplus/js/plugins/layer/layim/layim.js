...
var config = {
    msgurl: 'http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/mailbox.html?msg=',
    chatlogurl: 'http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/mailbox.html?user=',
    aniTime: 200,
    right: -232,
    api: {
        friend: 'http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/friend.json', //好友列表接口
        group: 'http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/group.json', //群组列表接口
        chatlog: 'http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/chatlog.json', //聊天记录接口
        groups: 'http://www.zi-han.net/theme/hplus/js/plugins/layer/layim/js/plugins/layer/layim/data/groups.json', //群组成员接口
        sendurl: '' //发送消息接口
    },
    user: { //当前用户信息
        name: '游客',
        face: '../../../../../../../orheaidcn.bkt.clouddn.com/a1.jpg'/*tpa=http://orheaidcn.bkt.clouddn.com/a1.jpg*/
    },
