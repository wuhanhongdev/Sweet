  ...
  InputManager.prototype._onPaste = function(e) {
    ...
    if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.items && e.originalEvent.clipboardData.items.length > 0) {
      ...
      if (/^image\//.test(pasteItem.type) && !cleanPaste) {
        ...
        if (!imageFile.name) {
          imageFile.name = "../../../../../../www.zi-han.net.img.800cdn.com/theme/hplus/js/plugins/simditor/Clipboard Image.png"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/simditor/Clipboard Image.png*/;
        }
        uploadOpt = {};
          ...
          if (pasteContent.is('p')) {
            ...
            if (children.length === 1 && children.is('img')) {
              ...
              if (/^data:image/.test($img.attr('src'))) {
                ...
                blob.name = "../../../../../../www.zi-han.net.img.800cdn.com/theme/hplus/js/plugins/simditor/Clipboard Image.png"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/simditor/Clipboard Image.png*/;
                uploadOpt = {};
...
Simditor = (function(_super) {
  ...
  Simditor.prototype.opts = {
    textarea: null,
    placeholder: '',
    defaultImage: '../../../../../../www.zi-han.net.img.800cdn.com/theme/hplus/js/plugins/simditor/images/image.png'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/simditor/images/image.png*/,
    params: {},
    upload: false,
    tabIndent: true
  };
        ...
        if (e.which === 13 && !_this.target.hasClass('uploading')) {
          ...
          return _this.button.loadImage(_this.target, src, function(success) {
            ...
            if (/^data:image/.test(src)) {
              ...
              blob.name = "../../../../../../www.zi-han.net.img.800cdn.com/theme/hplus/js/plugins/simditor/Base64 Image.png"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/simditor/Base64 Image.png*/;
