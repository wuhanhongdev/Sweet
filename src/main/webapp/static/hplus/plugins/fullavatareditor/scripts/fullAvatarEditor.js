function fullAvatarEditor() {
	...
	var file			= 'plugins/fullavatareditor/fullAvatarEditor.swf'/*tpa=http://www.zi-han.net/theme/hplus/plugins/fullavatareditor/scripts/plugins/fullavatareditor/fullAvatarEditor.swf*/;		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'expressInstall.swf'/*tpa=http://www.zi-han.net/theme/hplus/plugins/fullavatareditor/scripts/expressInstall.swf*/;			//expressInstall.swf的路径
