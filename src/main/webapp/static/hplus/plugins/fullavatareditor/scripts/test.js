swfobject.addDomLoadEvent(function () {
	...
	{
		sourcePic2Url = "../../../../../../www.baidu.com/search/error.html"/*tpa=http://www.baidu.com/http://orheaidcn.bkt.clouddn.com/bdlogo.png*/;
	}
    ...
    var swf1 = new fullAvatarEditor('swf1', 335, {
		id : 'swf1',
        upload_url : 'http://www.zi-han.net/theme/hplus/plugins/fullavatareditor/scripts/upload.php',
    ...
    var swf2 = new fullAvatarEditor('swf2', {
        id: 'swf2',
        upload_url: 'http://www.zi-han.net/theme/hplus/plugins/fullavatareditor/scripts/upload.php',	//上传图片的接口地址
